...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .header .sub{ margin-top: 6px; color: var(--muted); font-size: 14px; max-width: 680px; }
        ...
        .tile:hover{ transform: translateY(-2px); box-shadow: 0 14px 30px rgba(17,24,39,0.08); }

        .tile h3{ margin: 0 0 6px; font-size: 16px; }
        .tile p{ margin: 0 0 12px; color: var(--muted); font-size: 13px; line-height: 1.4; }
        ...
        .btn-warning{ background: var(--warning); color:#111827; border-color: transparent; }
    ...
    <div class="card">
        ...
        <div class="grid">
            ...
            <div class="tile">
                ...
                <div class="btnrow">
                    <!-- FIXED: your servlet is /reservations/view -->
            ...
            <div class="tile">
                ...
                <div class="btnrow">
                    <!-- We'll create /bills/view as a page so it won't 404 -->
            ...
            <div class="tile">
                ...
                <div class="btnrow">
                    <!-- FIXED: quick actions should hit /reservations/view -->
