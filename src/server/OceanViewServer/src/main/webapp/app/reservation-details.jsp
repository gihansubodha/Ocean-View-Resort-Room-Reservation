...
<div class="card">
    ...
    <%-- IMPORTANT: Search uses /reservations/search to avoid URL mapping conflict --%>
    <form method="get" action="<%= request.getContextPath() %>/reservations/search" style="margin-top:14px;">
        <div class="grid">
            <div class="field">
        ...
        <div style="margin-top:12px;">
            ...
            <%-- IMPORTANT: Today lists also use /reservations/search --%>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <%-- IMPORTANT: Opening a reservation stays on /reservations/view --%>
